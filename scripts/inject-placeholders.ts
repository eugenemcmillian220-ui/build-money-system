...
const PLACEHOLDERS: Record<string, string> = {
  ...
  GROQ_API_KEYS: "REPLACE_WITH_COMMA_SEPARATED_GROQ_KEYS",
  GEMINI_API_KEYS: "REPLACE_WITH_COMMA_SEPARATED_GEMINI_KEYS",
  OPENAI_API_KEYS: "REPLACE_WITH_COMMA_SEPARATED_OPENAI_KEYS",
  OPENROUTER_API_KEYS: "REPLACE_WITH_COMMA_SEPARATED_OPENROUTER_KEYS",
