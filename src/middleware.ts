...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy":
    ...
    "font-src 'self' data:; " +
    "connect-src 'self' https://*.supabase.co https://*.sentry.io https://api.stripe.com https://openrouter.ai https://api.groq.com https://api.openai.com https://api.deepseek.com https://generativelanguage.googleapis.com; " +
