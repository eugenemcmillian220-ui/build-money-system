...
import { Book, ShieldCheck, Zap, TrendingUp, Users } from "lucide-react";
...
export default function GuidePage() {
  const sections = [
    ...
    {
      title: "3. The 25-Agent Swarm",
      icon: Users,
      content: "When you manifest a project, 25 specialized AI agents collaborate. The Scout researches the market, the Architect designs the UI, the Developer writes the code, the Sentinel hardens security, and the Overseer performs E2E browser tests.",
