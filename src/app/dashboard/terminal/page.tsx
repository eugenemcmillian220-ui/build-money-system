    ...
    <div className="p-8 md:p-12">
      <div className="max-w-[1600px] mx-auto space-y-12">
        <header>
          ...
          <p className="text-muted-foreground font-bold italic">Direct command interface for project manifestation — with live code view.</p>
        </header>

        <ManifestWorkspace orgId={org?.id} />
      </div>
    </div>
  );
}
