...
export const CREDIT_PACKS: CreditPack[] = [
  {
    ...
    price: 2000,
    label: "Starter Pack",
    priceId: process.env.STRIPE_CREDITS_5K_PRICE_ID || "price_credits_5k"
  },
  {
    id: "credits_10k",
    credits: 10000,
    ...
    label: "Growth Pack",
    savings: "5% off",
    priceId: process.env.STRIPE_CREDITS_10K_PRICE_ID || "price_credits_10k"
  },
  {
    id: "credits_25k",
    credits: 25000,
    ...
    label: "Pro Pack",
    savings: "10% off",
    priceId: process.env.STRIPE_CREDITS_25K_PRICE_ID || "price_credits_25k"
  },
  {
    id: "credits_50k",
    credits: 50000,
    ...
    label: "Empire Pack",
    savings: "15% off",
    priceId: process.env.STRIPE_CREDITS_50K_PRICE_ID || "price_credits_50k"
  },
  {
    id: "credits_100k",
    credits: 100000,
    ...
    savings: "20% off",
    priceId: process.env.STRIPE_CREDITS_100K_PRICE_ID || "price_credits_100k"
  },
];
